...
public class TheClient extends UIFrame {
     ...
     */
    public void loadSettingFromProp(String path) throws FileNotFoundException, IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        _serverIP = prop.getProperty("serverIP", "192.168.0.103" );
    ...
    /**
     * get img from server and play on a JPanel
     * 
     * @throws IOException
